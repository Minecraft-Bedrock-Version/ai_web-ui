# ============================================================
# 방법 2: reasoning_effort: "low" 만 적용
# - 프롬프트는 기존 유지
...
def run_security_analysis(target_infra_json: str, retrieved_context: str) -> Optional[Dict[str, Any]]:
    """
    방법 2: reasoning_effort를 "low"로만 설정
    - 프롬프트는 기존과 동일
    """
    # 기존 프롬프트 유지
    prompt_template = f"""
...
"""
    ...
    payload = {
        ...
        "temperature": 0.2,
        "top_p": 0.9,
        "reasoning_effort": "low"  # 방법 2: low로 변경
    }
    ...
    try:
        ...
        print("\n" + "="*60)
        print("📊 [방법 2] Low Reasoning Effort Only 결과")
        print("="*60)
...
if __name__ == "__main__":
    print("\n🚀 [방법 2] Low Reasoning Effort Only 테스트 시작...")
    print("설정: 프롬프트 유지 + reasoning_effort='low'")

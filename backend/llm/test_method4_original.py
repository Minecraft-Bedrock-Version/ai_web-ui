# ============================================================
# 방법 4: 기존 방법 (원본 - Baseline)
# - 프롬프트 동일
# - reasoning_effort: "medium" (기존 설정)
# ============================================================
import json
import boto3
import os
...
"""
    ...
    payload = {
        ...
        "temperature": 0.2,
        "top_p": 0.9,
        "reasoning_effort": "medium"  # 방법 4: 기존 medium
    }
    ...
    try:
        ...
        print("\n" + "="*60)
        print("📊 [방법 4] Original Method (Baseline) 결과")
        print("="*60)
...
if __name__ == "__main__":
    print("\n🚀 [방법 4] Original Method (Baseline) 테스트 시작...")
    print("설정: 기존 프롬프트 + reasoning_effort='medium' (원본 그대로)")
